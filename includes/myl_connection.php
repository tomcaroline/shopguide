...
class DB{
    ...
    public function __construct() {     
        $this->db_host = appConfig::$dbConfig['db_host'];
        $this->db_user = appConfig::$dbConfig['db_user'];
        $this->db_pwd = appConfig::$dbConfig['db_pwd'];
        $this->db_database = appConfig::$dbConfig['db_database'];
        $this->coding = appConfig::$dbConfig['db_coding'];
        $this->conn = appConfig::$dbConfig['db_conn'];
        $this->connect();
    }
    ...
    public function show_databases() {
        ...
        echo "<br />";
        $i = 1;
        while (($row = $this->fetch_array()) !== false) {
            echo "$i $row[Database]";
            echo "<br />";
            $i++;
        }
